...
def exists():  # the name of the check
    """Is your file saved as assignment8.py?"""  # this is what you will see when running check50
    check50.exists("assignment8.py")  # the actual check
...
def main_test():
    ...
    check50.run("python3 assignment8.py").stdout("1749\n").exit(0)
